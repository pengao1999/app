        ...
        <scroll-view scroll-y class="scrollView" lower-threshold="200" :scroll-top="scrollTop" @scroll="scrollFn($event)">
            ...
            <view class="scroll-container" style="padding-top: 0px;">
                ...
                <block v-if="getShow">
                    ...
                    <view class="block-container" style="width: 750upx;">
                        <view class="justify-center" v-for="(product,index) in productList[0].goods" :key="index" style="width:50%;display: flex;margin-bottom: 20upx;">
                            <product-card :img="imgRoot+product.pic" :price="product.price" :title="product.name" :productKey="product.goods_key" @clickItem="toProduct"></product-card>
                        </view>
                    </view>
            ...
            getAd() {
                ...
                self.$Phttp.post(Config.JAVA_SAAS_URLS.getAds, {}).then(res => {
                    ...
                    if (res.code === 0) {
                        ...
                        self.swiperList = res.data.yuepinBanner
                    }
                })
            },
